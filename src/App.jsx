    ...
    <div className="min-h-screen text-slate-800 bg-gradient-to-b from-white to-slate-50">
      ...
      {/* Home */}
        <section
          ...
          style={{ backgroundImage: `url(${import.meta.env.BASE_URL}pot.jpg)`, backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
        ...
        <section id="experience" className="bg-slate-50 border-t border-slate-200/60 py-16 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-12 flex justify-center">
              <a
                href={`${import.meta.env.BASE_URL}PrarthanaSureshKumar_Resume.pdf`}
                download
...
<section id="projects" className="bg-white border-t border-slate-200/60">
  <div className="max-w-6xl mx-auto px-6 py-20">
    ...
    <div className="grid md:grid-cols-2 gap-8 mt-8">
      {[
        {
          img: `${import.meta.env.BASE_URL}project_image_1.png`,
        ...
        {
          img: `${import.meta.env.BASE_URL}project_image_2.png`,
        ...
        {
          img: `${import.meta.env.BASE_URL}project_image_3.png`,
        ...
        {
          img: `${import.meta.env.BASE_URL}project_image_4.png`,
        ...
        {
          img: `${import.meta.env.BASE_URL}project_image_5.png`,
